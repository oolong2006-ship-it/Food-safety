...
(function () {
  ...
  const CHECKLIST_TEMPLATES = {
    ...
    bakery: {
      name: 'تدقيق المخابز وإنتاج المعجنات والحلويات',
      sections: [
        { title: 'المواد الخام والمكوّنات', items: [
          'استلام الدقيق ومشتقاته من موردين معتمدين مع فواتير ووثائق المصدر',
          'فصل وتسمية المواد المسببة للحساسية (جلوتين، مكسرات، بيض، ألبان، سمسم) في مناطق تخزين مستقلة',
          'الزبدة والألبان والبيض محفوظة في الثلاجة ≤ 5°م مع بيانات تاريخ الفتح',
          'الخميرة والمواد الحافظة ضمن تاريخ الصلاحية ومخزّنة وفق اشتراطات المصنّع',
          'فحص المكوّنات بصريًا وشمّيًا عند الاستلام للكشف عن التلف أو التلوث',
          'تطبيق نظام FIFO على جميع المواد الخام',
        ]},
        { title: 'تحضير العجائن والتشكيل', items: [
          'آلات العجن نظيفة ومعقمة قبل الاستخدام وبعد كل دورة إنتاج',
          'أسطح العجن مصنوعة من مواد معتمدة سهلة التعقيم (ستانلس ستيل أو رخام)',
          'ضبط وتوثيق درجات حرارة التخمير وفق الوصفة المعتمدة',
          'فصل تام لعجائن تحتوي مسببات الحساسية عن الأصناف الأخرى (أدوات وأسطح منفصلة)',
          'تغطية العجائن أثناء التخمير بمواد غذائية آمنة لمنع التلوث',
          'عدم مخالطة الأغذية النيئة للجاهزة في مناطق التشكيل',
        ]},
        { title: 'عمليات الخبز والطهي', items: [
          'ضبط وتوثيق درجات حرارة الأفران وفق متطلبات كل منتج',
          'معايرة مستشعرات الحرارة في الأفران بصفة دورية موثّقة مع سجل المعايرة',
          'التحقق من اكتمال الخبز باللون الخارجي ودرجة الحرارة الداخلية للمنتج',
          'تهوية الأفران وشفط الدخان والأبخرة بشكل فعّال',
          'عدم خلط صواني الخبز من أصناف مختلفة في نفس الدورة (خاصة عند وجود مسببات حساسية)',
        ]},
        { title: 'التبريد والتغليف والتسمية', items: [
          'تبريد المنتجات الساخنة إلى أقل من 21°م قبل التغليف لمنع التكثيف والفطريات',
          'التغليف في بيئة نظيفة بعيدة عن مناطق الطهي والغبار والحشرات',
          'الإفصاح عن مسببات الحساسية الموجودة (جلوتين، بيض، ألبان، مكسرات، سمسم) بوضوح على البطاقة وفق GSO 2233',
          'إثبات تاريخ الإنتاج وتاريخ الانتهاء أو مدة الصلاحية على كل منتج',
          'تخزين المنتجات الجاهزة بعيدًا عن الرطوبة والحشرات وبعيدًا عن مواد التنظيف',
        ]},
        { title: 'المعدات المتخصصة والمرافق', items: [
          'الأفران والمعدات الحرارية: صيانتها الدورية موثّقة وتعمل بأمان كامل',
          'آلات التقطيع والتشكيل نظيفة وخالية من بقايا عجائن أو دهون سابقة',
          'تخزين السكريات والمواد المكملة في أوعية محكمة بعيدًا عن الرطوبة والآفات',
          'فصل صنابير غسل الأدوات عن صنابير غسل الأيدي — لا تخلط بينهما',
          'سجل صيانة المعدات محدَّث ويغطي الفترة الأخيرة',
        ]},
      ]
    },
    cafe: {
      name: 'تدقيق الكافيهات ومحلات العصائر والمشروبات',
      sections: [
        { title: 'المشروبات الساخنة (القهوة والشاي)', items: [
          'مكائن الإسبريسو تُنظَّف وتُفرَّغ وتُشطَف وفق جدول التنظيف اليومي',
          'حليب الإسبريسو يُبخَّر طازجًا ولا يُسخَّن مرتين ولا يُترك أكثر من دقيقتين بعد التبخير',
          'الحليب الكامل والبدائل النباتية محفوظة في الثلاجة ≤ 5°م وتُعاد العبوة للثلاجة فورًا بعد الاستخدام',
          'خلاطات الشراب وموزعات السكر وصواني التقديم تُغسل وتُعقّم يوميًا',
          'مستلزمات التقديم (أكواب / ماصات / أغطية) مخزّنة بطريقة صحية بعيدًا عن التلوث والحشرات',
        ]},
        { title: 'العصائر الطازجة والمشروبات الباردة', items: [
          'الفواكه والخضار مغسولة جيدًا بماء نظيف قبل العصر',
          'آلات العصر والخلاطات تُفكَّك وتُغسَّل وتُعقَّم كل 4 ساعات على الأقل وفي نهاية كل وردية',
          'العصائر الطازجة تُقدَّم فورًا أو تُبرَّد ≤ 4°م وتُتلف خلال ساعتين من الإعداد',
          'الثلج مصنوع من ماء شرب آمن أو مُشتَرى من موردين معتمدين',
          'أدوات إضافة الثلج (كماشات/مغارف) نظيفة ومعقمة ومحفوظة بعيدًا عن التلوث',
        ]},
        { title: 'التخزين البارد وسلامة المواد الخام', items: [
          'سعة التبريد كافية للفصل بين الحليب والكريمة والعصائر والفواكه المقطعة',
          'تأريخ عبوات الحليب والكريمة المفتوحة بتاريخ الفتح والانتهاء بعد الفتح',
          'أسيروب وشراب النكهة محفوظ وفق اشتراطات المصنّع ومغلق وموسوم بوضوح',
          'التحقق اليومي من درجات حرارة الثلاجات وتسجيلها في سجل مخصص',
          'التخلص الفوري من الفواكه والعصائر المشبوهة أو منتهية الصلاحية',
        ]},
        { title: 'إدارة مسببات الحساسية', items: [
          'وضع قائمة واضحة بمسببات الحساسية في كل مشروب (ألبان، مكسرات، صويا، جلوتين)',
          'تدريب جميع العاملين على بروتوكول التعامل مع طلبات الزبائن الذين لديهم حساسية',
          'تنظيف الخلاطات والأكواب تنظيفًا شاملًا عند التبديل بين مشروبات تحتوي مكسرات وأخرى لا تحتوي',
          'البدائل النباتية للحليب (صويا / شوفان / لوز) مُعلَّمة ومخزَّنة في أوعية منفصلة واضحة البيانات',
        ]},
        { title: 'نظافة منطقة العمل والعاملون', items: [
          'أسطح تحضير المشروبات تُمسح وتُعقَّم كل ساعتين وبعد كل فترة ذروة',
          'غسل الأيدي إلزامي بعد مناولة النقود أو لمس الأسطح غير الغذائية',
          'العاملون يرتدون قفازات عند تحضير مشروبات باردة أو ملامسة الثلج',
          'عدم استخدام نفس الأدوات لأصناف مختلفة دون تنظيف وتعقيم مسبق',
          'الشهادات الصحية سارية لجميع العاملين وفق اشتراطات SFDA',
        ]},
      ]
    }
  };
  ...
  function importJSON(text) {
    let obj;
    try { obj = JSON.parse(text); } catch (e) { throw new Error('ملف JSON غير صالح: ' + e.message); }
    if (!obj || typeof obj !== 'object' || Array.isArray(obj)) throw new Error('هيكل الملف غير صالح');
    if (!obj.meta || typeof obj.meta !== 'object') throw new Error('الملف لا يحتوي بيانات المنشأة (meta) المطلوبة');
    const required = ['employees', 'tempLogs', 'inspections', 'ncs', 'suppliers'];
    for (const field of required) {
      if (!Array.isArray(obj[field])) throw new Error('الملف لا يحتوي الحقل المطلوب: ' + field);
    }
    db = obj; save();
  }
